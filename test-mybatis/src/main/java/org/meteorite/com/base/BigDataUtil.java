...
//            reader = new InputStreamReader(new FileInputStream("C:\\Users\\EX_052100260\\Downloads\\msgtask652_0924082734714.csv"), CharEncoding.UTF_8);
            ...
            InputStream skipBomInputStream = getSkipBomInputStream(new FileInputStream("C:\\Users\\EX_052100260\\Downloads\\msgtask664_0924173005720.csv"));
...
//                log.info(" old item :{}", item);
                if (getDecryptPhoneNum(item.getPhoneNumber()).equals("18212779545") ||
                        getDecryptPhoneNum(item.getPhoneNumber()).equals("17374415427")) {
                    log.info("item :{}", item);
            ...
            listUser.stream().forEach(item -> {
                ...
                if (item.getPhoneNumber().equals("18212779545") ||
                        item.getPhoneNumber().equals("17374415427")) {
                    log.info("item :{}",item);
                }
