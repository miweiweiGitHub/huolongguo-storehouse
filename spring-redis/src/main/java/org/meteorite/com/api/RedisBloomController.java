...
import org.meteorite.com.domain.UserVO;
import org.meteorite.com.base.util.BloomFilterHelper;
import org.meteorite.com.base.util.RedisBloomUtil;
...
public class RedisBloomController {
    ...
    @Resource
    private RedisBloomUtil redisUtil;
    ...
    public ResponseEntity<String> findEmailInBloom(@RequestBody String params) {
        ...
        try {
            ...
            BloomFilterHelper<String> myBloomFilterHelper = new BloomFilterHelper<>(
                    (Funnel<String>) (from, into) -> into.putString(from, Charsets.UTF_8).putString(from, Charsets.UTF_8), 1500000, 0.00001);
