...
import org.meteorite.com.base.config.LocalDateTimeConverter;
...
public class EasyExcelUtil {
    ...
    public static void write(String filePath, Class headClazz, List data) {
        EasyExcel.write(filePath, headClazz).registerConverter(new LocalDateTimeConverter()).sheet().doWrite(data);
    }
